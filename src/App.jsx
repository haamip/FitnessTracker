...
function WorkoutDetailRoute() { const { id = "workout-1" } = useParams(); return <WorkoutDetail key={id} />; }
function RouteFallback() { return <div className="screen" style={{display:"grid",placeItems:"center",minHeight:"60vh"}}><div style={{textAlign:"center"}}><strong>Loading TrackFit...</strong><p style={{margin:"8px 0 0",color:"#777",fontWeight:800}}>Preparing your screen.</p></div></div>; }
...
export default function App() { return <BrowserRouter><AuthGate><AppRoutes /></AuthGate></BrowserRouter>; }
